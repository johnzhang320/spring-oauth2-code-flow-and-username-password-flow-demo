...
public class AccessTokenForm {
	...
	public String toString() {
		return "AccessTokenForm [clientId=" + clientId + ", clientSecret=" + clientSecret + ", authCode=" + authCode
				+ ", redirectUrl=" + redirectUrl + ", base_token_url=" + base_token_url + ", credentials=" + credentials
				+ ", encodedCredentials=" + encodedCredentials + ", accessTokenRequestUrl=" + accessTokenRequestUrl
				+ ", tokenStringReponse=" + tokenStringReponse + ", accessTokenString=" + accessTokenString
				+ ", resourceRequestURL=" + resourceRequestURL + ", resourceRequestHeader=" + resourceRequestHeader
				+ ", urlIndex=" + urlIndex + ", nextRUL=" + nextRUL + "]";
	}
