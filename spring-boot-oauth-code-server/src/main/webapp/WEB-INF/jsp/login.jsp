...
<html lang="en">
	...
	<!-- Front End Encryption Customized Code -->
		...
		<script type="text/javascript"> 
			$(document).ready(function(){
				...
				stringCryption.getPublicKey("/spring-boot-oauth-server/getKeyPair.html")
  ...
  <body>
    ...
    <div class="container">
        <h2 class="text-info text-center">Log In Authorization Server</h2>
		<h4 class="text-info text-center">Authorization Server provides this page to authenticate if you are a Resource Owner</h4>
		<h4 class="text-info text-center">Once you successfully login this page, you will get authorization to access resource</h4>
