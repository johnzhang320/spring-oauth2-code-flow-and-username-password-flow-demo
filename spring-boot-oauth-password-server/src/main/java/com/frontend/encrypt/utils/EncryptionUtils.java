...
public class EncryptionUtils {
	...
	public static void main(String[] args) throws Exception{
      ...
      encryptedString = handler.encrypt("larry123" );
      Log.info("Encrypted String:" + encryptedString);
      String username_seeds = encryptedString+"|"+seedStr4IV;
      Log.info("username_seeds:" + username_seeds);
      
      int seperate = username_seeds.indexOf("|");
      
      String username = username_seeds.substring(0,seperate);
    
      String seedStr = username_seeds.substring(seperate+1);
      
      Log.info("username: "+handler.decrypt(encryptedString));
      Log.info("Seed4IV: "+seedStr);  
